 ...
 * audio samples with a custom sample generator configuration, and print the sample
 * values to stdout.
 *
...
int main(int argc, char *argv[])
{
    ...
    // Create and initialize PTTTL sample generator object with custom configuration
    ptttl_sample_generator_t generator;

    ptttl_sample_generator_config_t config = {
        .sample_rate=22050u,    // Use 22.05KHz sampling rate
        .attack_samples=5000u,  // Note beginning ramps from 0 to full amplitude over 5000 samples
        .decay_samples=10000u,   // Note end ramps from full amplitude to 0 over 10000 samples
        .amplitude=1.0f         // Full note amplitude (100%)
    };
